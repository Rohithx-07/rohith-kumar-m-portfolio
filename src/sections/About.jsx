                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <p className="text-gray-400 leading-relaxed mb-6">
                            I am a dedicated and innovative engineering student with a strong foundation in modern web development, software engineering. My goal is to leverage technology to build scalable, impactful, and user-centric solutions.
                        </p>
                    ...
                    >
                        <div className="glass p-6 rounded-2xl border-l-4 border-l-primary flex items-start gap-4 hover:-translate-y-1 transition-transform">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-1">2023 - 2027</p>
                            </div>
                        </div>
                    </motion.div>
                </div>
